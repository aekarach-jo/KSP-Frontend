...
import ControlsPageSize from '../../printingDailyPlan/table/components/ControlsPageSize';
import ControlsAdd from '../../printingDailyPlan/table/components/ControlsAdd';
import ControlsEdit from '../../printingDailyPlan/table/components/ControlsEdit';
import ControlsDelete from '../../printingDailyPlan/table/components/ControlsDelete';
import ControlsSearch from '../../printingDailyPlan/table/components/ControlsSearch';
import ModalAddEdit from '../../printingDailyPlan/table/components/ModalAddEdit';
import CardContainer from './components/CardSummary';
import TablePagination from '../../printingDailyPlan/table/components/TablePagination';
import ResponsiveNav from '../../printingDailyPlan/table/components/ResponsiveNav';
import TableDataNotFound from '../../printingDailyPlan/table/components/TableDataNotFound';
...
const TableCard = ({ setShowModal, setProductId, tabs = [], ...tableConfig }) => {
    ...
    <Row className="mb-3">
      <Col sm="12" md="5" lg="3" xxl="2">
        {!tableInstanceHeader?.hideSearch && (
          <>
            <div>{f({ id: 'printingDailyPlan.list.dateRange' })}</div>
            <div className='d-flex flex-row justify-content-center align-items-center gap-2'>
              <Col sm='10' md='10' lg='10'>
                <div className="d-inline-block float-md-start me-1 my-1 mb-md-0 search-input-container w-100 shadow bg-foreground">
                  <DatepickerThaiYearRange tableInstance={tableInstanceHeader} show={showFilter} toggleFilter={!showFilter} onReset={onReset} setOnReset={setOnReset}/>
                </div>
              </Col>
              <Col sm='2' md='2' lg='2'>
  ...
  const renderContainer = ({ isLoading, tableInstance: tableInstanceContainer }) => (
    ...
    >
      <Row>
        <Col xs="12">
          <CardContainer setShowModal={setShowModal} setProductId={setProductId} className="react-table rows" tableInstance={tableInstanceContainer} />
