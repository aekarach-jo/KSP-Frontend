...
import { Badge, Col, Form, Nav, Row, Tab, ToggleButton, Button } from 'react-bootstrap';
import { useTable, useGlobalFilter, useSortBy, usePagination, useRowSelect, useRowState } from 'react-table';
import CsLineIcons from 'cs-line-icons/CsLineIcons';
import classNames from 'classnames';
import ReactToPrint from 'react-to-print';
import {DatepickerRangeMultiple, DatepickerRangeSingle} from '../../../../components/forms/controls/datepicker/DatepickerRange';
      ...
      <Col sm="12" md="5" lg="3" xxl="2">
        {!tableInstanceHeader?.hideSearch && (
          <div className="d-inline-block float-md-start me-1 mb-1 mb-md-0 search-input-container w-100 shadow bg-foreground">
            ...
            <DatepickerThaiYear tableInstance={tableInstanceHeader}
