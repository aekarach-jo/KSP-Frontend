  ...
  return (
    <Card
      className={clx('mb-3 pt-0 ps-3 pb-0', {
        'overlay-spinner': isLoadingGroup,
      })}
    >
      <Accordion flush>
        <Accordion.Item eventKey="1">
          <Accordion.Header as="div" className="pb-0">
            <h2 className="font-weight-bold pb-0">{f({ id: 'dailyPlan.group' })}</h2>
          </Accordion.Header>
                              ...
                              {isMobile ? (
                                <>
                                  <OverlayScrollbarsComponent
                                    ...
                                    style={{ maxWidth: '1920px', borderRadius: '10px' }}
                                  >
                                    <div className=" d-flex flex-row justify-content-start align-items-center">
                                      <div className="card-style" style={{ width: '420px' }}>
                                        ...
                                        >
                                          {dataDate?.itemList?.map((items, indexI) => {
                                            ...
                                            if (items?.producedProductSize) {
                                              ...
                                              const red =
                                                Math.floor(
                                                  (length / 100 > 1 ? getLastTwoDigits(length) / 100 : length / 100) * (redRange[1] - redRange[0] + 1)
                                                ) + redRange[0];
                                              const green =
                                                Math.floor(
                                            ...
                                            return (
                                              <Card
                                                ...
                                                className={clx('sh-4 ps-3 pt-0 pb-0 d-flex h-100 card-style mb-1 justify-content-center align-items-start', {
                                                  'dp-n': !displayFilter(filter, items),
                                                })}
                                                style={{ width: '520px', background: hex }}
                                                data-product-name={items.productAbbr}
                                              >
                                                <div className="d-flex">
                                                  <div style={{ minWidth: '20px' }} className="d-flex flex-column justify-content-center align-items-center">
                                                    <Form.Check
                                                      className="form-check  m-1 min-h-0"
                                                      type="checkbox"
                                                      onClick={(e) => handleSelectItem(items, e)}
                                                    />
                                                  </div>
                                                  <div style={{ minWidth: '20px' }} className="d-flex flex-column justify-content-center align-items-end">
                                      ...
                                      <div className="card-style" style={{ width: '60%' }}>
                                        ...
                                        >
                                          <>
                                            <div className="d-flex">
                                              <div style={{ minWidth: '210px' }} className="d-flex flex-column justify-content-center align-items-start">
                                                <div className="ps-4">{f({ id: 'dailyPlan.field.step' })}</div>
                                              </div>
                                              <div style={{ minWidth: '260px' }} className="d-flex flex-column justify-content-center align-items-start">
                                              ...
                                              <div style={{ minWidth: '120px' }} className="d-flex flex-column justify-content-center align-items-start">
                                          ...
                                          {dataDate?.itemList?.map((items, indexI) => {
                                            ...
                                            return (
                                              <Card
                                                key={indexI}
                                                id={items?.saleOrderDetailId || ''}
                                                style={{ width: '1750px', background: hex }}
                                              ...
                                              >
                                                <div style={{ minWidth: '230px' }} className="d-flex flex-column justify-content-center align-items-start ps-2">
                                                  <div>
                                                    {`${items?.step?.label}` || ''}
