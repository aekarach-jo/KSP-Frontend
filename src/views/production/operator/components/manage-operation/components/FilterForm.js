...
const FilterForm = ({ show, tableInstance }) => {
  ...
  const handleChangeCheck = (value) => {
    handleChange({ target: { id: 'isEmptyMachine', value: value.target.value } });
  };
                ...
                <Row>
                  <Col xs={12} md={2} className="mb-3">
                    <div className="mb-3 form-floating">
                      <Form.Control type="text" name="machineName" onChange={handleChange} value={values.machineName} autoComplete="off" disabled={values.isEmptyMachine} />
