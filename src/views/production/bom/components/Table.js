...
import ControlsPageSize from 'views/sales/components/table/components/ControlsPageSize';
import ControlsAdd from 'views/sales/components/table/components/ControlsAdd';
import ControlsEdit from 'views/sales/components/table/components/ControlsEdit';
import ControlsDelete from 'views/sales/components/table/components/ControlsDelete';
import ControlsSearch from 'views/sales/components/table/components/ControlsSearch';
import ModalAddEdit from 'views/sales/components/table/components/ModalAddEdit';
import TableBody from 'views/sales/components/table/components/Table';
import TablePagination from 'views/sales/components/table/components/TablePagination';
import ResponsiveNav from 'views/sales/components/table/components/ResponsiveNav';
import TableDataNotFound from 'views/sales/components/table/components/TableDataNotFound';
    ...
    >
      <Row>
        <Col xs="12" style={{ overflowX: 'auto' }}>
          <TableBody className="react-table rows" tableInstance={tableInstanceContainer} />
