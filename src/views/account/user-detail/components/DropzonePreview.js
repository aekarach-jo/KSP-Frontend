...
const DropzonePreview = ({ meta, fileWithMeta }) => {
  ...
  return (
    <Row className="w-100 h-100 border border-1 border-separator g-0 rounded-md me-2 position-relative z-index-1">
      <Col xs="auto" className="position-relative">
        {previewUrl ? (
          <img src={previewUrl} alt="preview image" className="sw-30 sh-21 rounded-sm-start" />
        ) : (
