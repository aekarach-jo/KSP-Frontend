...
const AddStatusTypeItemModal = ({ show, onHide, list, onAdd, onRemove, codeResult, abbrResult, nameResult, onSave, errCodeItemModal }) => {
    ...
    return [
      {
        ...
        accessor: 'code',
        headerClassName: 'text-muted text-uppercase text-center',
      },
      {
        ...
        Cell: ({ row, removeTypeTooling }) => {
          ...
          return (
            ...
            <Button
              ...
              disabled={row?.original?.isConstant}
            >
          ...
          <Col>
            <Card body>
              <Form onSubmit={handleSubmit}>
                ...
                {errCodeItemModal !== undefined && <div className="d-block invalid-feedback">{errCodeItemModal}</div>}
...
export default AddStatusTypeItemModal;
