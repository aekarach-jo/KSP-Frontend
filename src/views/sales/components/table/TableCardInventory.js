...
import CardContainer from './components/CardInventory';
...
const TableCardInventory = ({ setShowModal, setProductId, tabs = [], ...tableConfig }) => {
...
export default TableCardInventory;
