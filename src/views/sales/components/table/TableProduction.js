...
import TableBody from './components/TableProductionGroup';
...
const Table = ({ tabs = [], rowProps, ...tableConfig }) => {
    ...
    >
      <Row>
        <Col xs="12" style={{ overflowX: 'auto' }}>
          <TableBody className="react-table rows" tableInstance={tableInstanceContainer} rowProps={rowProps} />
