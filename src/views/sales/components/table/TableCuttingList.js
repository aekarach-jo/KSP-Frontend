...
import CardContainer from './components/TableGroup';
...
const TableCuttingList = ({ setShowModal, setProductId, setProductList, setShowButtonAdd, tabs = [], rowProps, ...tableConfig }) => {
  ...
  const renderContainer = ({ isLoading, tableInstance: tableInstanceContainer }) => {
    return (
      <div>
        {tableInstanceContainer?.planTab === 1 ? (
          <Row>
            <Col xs="12">
              <CardContainer
...
export default TableCuttingList;
