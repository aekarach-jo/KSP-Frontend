            ...
            <Col sm="12" md="3" lg="3" xxl="2">
              <>
                <Button
                  ...
                  onClick={() => saveEdit(stateList)}
                >
                  <CsLineIcons icon="save" /> <span>Change</span>
                </Button>
              </>
            </Col>
          </>
        )}
        <Col sm="12" md="2" lg={isBatch ? '5' : '9'} xxl={isBatch ? '6' : '10'} className="text-end">
