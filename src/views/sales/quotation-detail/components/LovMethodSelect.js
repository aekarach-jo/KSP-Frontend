...
import useQuotationLov from 'hooks/api/master/lov/useQuotationLov';
...
const LovMethodSelect = ({
  ...
  const { useMethodLov } = useQuotationLov();
  const { data, isFetching } = useMethodLov({ isGroup: true });
...
export default LovMethodSelect;
