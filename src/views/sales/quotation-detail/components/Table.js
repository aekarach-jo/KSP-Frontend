...
import ControlsPageSize from '../../components/table/components/ControlsPageSize';
import ControlsAdd from '../../components/table/components/ControlsAdd';
import ControlsEdit from '../../components/table/components/ControlsEdit';
import ControlsDelete from '../../components/table/components/ControlsDelete';
import ControlsSearch from '../../components/table/components/ControlsSearch';
import ModalAddEdit from '../../components/table/components/ModalAddEdit';
import TableBody from '../../components/table/components/Table';
import TablePagination from '../../components/table/components/TablePagination';
import ResponsiveNav from '../../components/table/components/ResponsiveNav';
import TableDataNotFound from '../../components/table/components/TableDataNotFound';
