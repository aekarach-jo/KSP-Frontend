...
const initialValues = { no: '', startTransferredAt: '', endTransferredAt: '' };
const statusOptions = [
  { value: 'NEW', label: 'NEW' },
                  ...
                  <Row>
                    ...
                    <Col xs={12} md={6} className="mb-3">
                      ...
                      <DatepickerThaiYearRangeSubmit
                        onChange={(value) => {
                          handleChange({ target: { id: 'startTransferredAt', value: value.dateRange[0] } });
                          handleChange({ target: { id: 'endTransferredAt', value: value.dateRange[1] } });
                        }}
                      />
                    </Col>
                    <Col xs={12} md={6} className="mb-3">
