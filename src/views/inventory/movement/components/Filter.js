...
const initialValues = { materialCode: '', materialName: '', productCode: '', productName: '', startUpdatedDate: '', endUpdatedDate: '' };
                ...
                <Form onSubmit={handleSubmit}>
                  <Row>
                    <Col xs={12} md={6} className="mb-3">
                      <Form.Label>{f({ id: 'movement.materialName' })}</Form.Label>
                      <Form.Control type="text" name="materialName" onChange={handleChange} value={values.materialName || ''} />
                    </Col>
                    <Col xs={12} md={6} className="mb-3">
                      <Form.Label>{f({ id: 'movement.dateRange' })}</Form.Label>
                    ...
                    <Col xs={12} md={6} className="mb-3">
                      ...
                      <Form.Control type="text" name="productCode" onChange={handleChange} value={values.productCode || ''} />
                    </Col>
                    <Col xs={12} md={6} className="mb-3">
                      <Form.Label>{f({ id: 'production.group.field.productName' })}</Form.Label>
                      <Form.Control type="text" name="productName" onChange={handleChange} value={values.productName || ''} />
                    </Col>
                    {/* <Col xs={12} md={6} className="mb-3">
                      <Form.Label>{f({ id: 'movement.type' })}</Form.Label>
                      <Select
